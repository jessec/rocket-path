 ...
 * @author Martti Tamm
 */
@TreeNode(childTypes = { BeanChildBuilder1.class, BeanChildBuilder1.class, BeanChildBuilder1.class })
public final class BeanChildBuilder1 implements TreeNodeBuilderAware {

  @Override
  public void initNode(TreeNodeBuilder node) {
    node.addChild("123", "abc");
  }
}
