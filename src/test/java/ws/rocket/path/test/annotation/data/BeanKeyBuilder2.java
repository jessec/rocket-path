 ...
 * key returned by the implemented method must be used when creating the tree node, even if the returned value is
 * <code>null</code>.
 *
 * @author Martti Tamm
 */
@Named("keyBuilder2")
@TreeNode(key = "keyBuilder2")
public final class BeanKeyBuilder2 implements KeyBuilder {
