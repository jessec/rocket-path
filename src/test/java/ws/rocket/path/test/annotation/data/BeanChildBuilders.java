 ...
 * <ol>
 * <li>key object (of the tree node) lookup by bean type (attribute <code>keyType</code>); note that the "root" bean is
 ...
 * @author Martti Tamm
 */
@TreeNode(keyType = Root.class, childTypes = { BeanChildBuilder1.class, BeanChildBuilder2.class })
public final class BeanChildBuilders {
